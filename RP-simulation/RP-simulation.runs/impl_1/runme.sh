...
HD_PWD='C:/Users/John/Desktop/Honours_Project/RP-simulation/RP-simulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sliding_DFT_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sliding_DFT_Processor.tcl -notrace
