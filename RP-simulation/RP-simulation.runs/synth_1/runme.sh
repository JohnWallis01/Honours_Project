...
HD_PWD='C:/Users/John/Desktop/Honours_Project/RP-simulation/RP-simulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sliding_DFT_Processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sliding_DFT_Processor.tcl
