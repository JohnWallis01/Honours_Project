...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(Clock, Reset, Modulated_Signal, 
  Reference_Signal, Threshold, Demodulated_Signal)
/* synthesis syn_black_box black_box_pad_pin="Clock,Reset,Modulated_Signal[13:0],Reference_Signal[13:0],Threshold[27:0],Demodulated_Signal" */;
  input Clock;
  input Reset;
