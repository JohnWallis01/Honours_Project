...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PSK_Demodulator is
  ...
  signal Input_Mixer_n_0 : STD_LOGIC;
  signal Input_Mixer_n_1 : STD_LOGIC;
  signal Input_Mixer_n_10 : STD_LOGIC;
  signal Input_Mixer_n_11 : STD_LOGIC;
  signal Input_Mixer_n_12 : STD_LOGIC;
  signal Input_Mixer_n_13 : STD_LOGIC;
  ...
  signal Input_Mixer_n_2 : STD_LOGIC;
  ...
  signal Input_Mixer_n_3 : STD_LOGIC;
  ...
  signal Input_Mixer_n_4 : STD_LOGIC;
  ...
  signal Input_Mixer_n_5 : STD_LOGIC;
  ...
  signal Input_Mixer_n_6 : STD_LOGIC;
  signal Input_Mixer_n_7 : STD_LOGIC;
  signal Input_Mixer_n_8 : STD_LOGIC;
  signal Input_Mixer_n_9 : STD_LOGIC;
...
Input_Mixer: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Mixer
     port map (
      Clock => Clock,
      DI(3) => Input_Mixer_n_4,
      DI(2) => Input_Mixer_n_5,
      DI(1) => Input_Mixer_n_6,
      DI(0) => Input_Mixer_n_7,
      Dout_reg_0(3) => Input_Mixer_n_8,
      Dout_reg_0(2) => Input_Mixer_n_9,
      Dout_reg_0(1) => Input_Mixer_n_10,
      Dout_reg_0(0) => Input_Mixer_n_11,
      Dout_reg_1(3) => Input_Mixer_n_12,
      Dout_reg_1(2) => Input_Mixer_n_13,
      Dout_reg_1(1) => Input_Mixer_n_14,
      Dout_reg_1(0) => Input_Mixer_n_15,
      Dout_reg_10(3) => Input_Mixer_n_44,
      Dout_reg_10(2) => Input_Mixer_n_45,
      Dout_reg_10(1) => Input_Mixer_n_46,
      Dout_reg_10(0) => Input_Mixer_n_47,
      Dout_reg_11(3) => Input_Mixer_n_48,
      Dout_reg_11(2) => Input_Mixer_n_49,
      Dout_reg_11(1) => Input_Mixer_n_50,
      Dout_reg_11(0) => Input_Mixer_n_51,
      Dout_reg_12(1) => Input_Mixer_n_52,
      Dout_reg_12(0) => Input_Mixer_n_53,
      Dout_reg_13(1) => Input_Mixer_n_54,
      Dout_reg_13(0) => Input_Mixer_n_55,
      Dout_reg_2(3) => Input_Mixer_n_16,
      Dout_reg_2(2) => Input_Mixer_n_17,
      Dout_reg_2(1) => Input_Mixer_n_18,
      Dout_reg_2(0) => Input_Mixer_n_19,
      Dout_reg_3(3) => Input_Mixer_n_20,
      Dout_reg_3(2) => Input_Mixer_n_21,
      Dout_reg_3(1) => Input_Mixer_n_22,
      Dout_reg_3(0) => Input_Mixer_n_23,
      Dout_reg_4(1) => Input_Mixer_n_24,
      Dout_reg_4(0) => Input_Mixer_n_25,
      Dout_reg_5(1) => Input_Mixer_n_26,
      Dout_reg_5(0) => Input_Mixer_n_27,
      Dout_reg_6(3) => Input_Mixer_n_28,
      Dout_reg_6(2) => Input_Mixer_n_29,
      Dout_reg_6(1) => Input_Mixer_n_30,
      Dout_reg_6(0) => Input_Mixer_n_31,
      Dout_reg_7(3) => Input_Mixer_n_32,
      Dout_reg_7(2) => Input_Mixer_n_33,
      Dout_reg_7(1) => Input_Mixer_n_34,
      Dout_reg_7(0) => Input_Mixer_n_35,
      Dout_reg_8(3) => Input_Mixer_n_36,
      Dout_reg_8(2) => Input_Mixer_n_37,
      Dout_reg_8(1) => Input_Mixer_n_38,
      Dout_reg_8(0) => Input_Mixer_n_39,
      Dout_reg_9(3) => Input_Mixer_n_40,
      Dout_reg_9(2) => Input_Mixer_n_41,
      Dout_reg_9(1) => Input_Mixer_n_42,
      Dout_reg_9(0) => Input_Mixer_n_43,
...
\PRBS_output0__13_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => Input_Mixer_n_32,
      DI(2) => Input_Mixer_n_33,
      DI(1) => Input_Mixer_n_34,
      DI(0) => Input_Mixer_n_35,
      O(3 downto 0) => \NLW_PRBS_output0__13_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => Input_Mixer_n_28,
      S(2) => Input_Mixer_n_29,
      S(1) => Input_Mixer_n_30,
      S(0) => Input_Mixer_n_31
    );
\PRBS_output0__13_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => Input_Mixer_n_40,
      DI(2) => Input_Mixer_n_41,
      DI(1) => Input_Mixer_n_42,
      DI(0) => Input_Mixer_n_43,
      O(3 downto 0) => \NLW_PRBS_output0__13_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => Input_Mixer_n_36,
      S(2) => Input_Mixer_n_37,
...
\PRBS_output0__13_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => Input_Mixer_n_48,
      DI(2) => Input_Mixer_n_49,
      DI(1) => Input_Mixer_n_50,
      DI(0) => Input_Mixer_n_51,
      O(3 downto 0) => \NLW_PRBS_output0__13_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => Input_Mixer_n_44,
      S(2) => Input_Mixer_n_45,
      S(1) => Input_Mixer_n_46,
      S(0) => Input_Mixer_n_47
    );
\PRBS_output0__13_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => Input_Mixer_n_54,
      DI(0) => Input_Mixer_n_55,
...
\PRBS_output0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => Input_Mixer_n_12,
      DI(2) => Input_Mixer_n_13,
      DI(1) => Input_Mixer_n_14,
      DI(0) => Input_Mixer_n_15,
      O(3 downto 0) => \NLW_PRBS_output0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => Input_Mixer_n_8,
      S(2) => Input_Mixer_n_9,
      S(1) => Input_Mixer_n_10,
      S(0) => Input_Mixer_n_11
    );
\PRBS_output0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => Input_Mixer_n_20,
      DI(2) => Input_Mixer_n_21,
      DI(1) => Input_Mixer_n_22,
      DI(0) => Input_Mixer_n_23,
      O(3 downto 0) => \NLW_PRBS_output0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => Input_Mixer_n_16,
      S(2) => Input_Mixer_n_17,
      S(1) => Input_Mixer_n_18,
      S(0) => Input_Mixer_n_19
    );
\PRBS_output0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => Input_Mixer_n_26,
      DI(0) => Input_Mixer_n_27,
