...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(PLL_Guess_Freq, Internal_Debug_Freq, 
  ADC_Override, FIFO_out, FIFO_clock, Control_Kp, Control_Ki, Freq_Measured, 
  s_axis_tdata_ADC_Stream_in, s_axis_tvalid_ADC_Stream_in, s_axis_tready_ADC_Stream_in, 
  DAC_Stream_out, AD_CLK_in, Sys_CLK_in, Reset_In)
/* synthesis syn_black_box black_box_pad_pin="PLL_Guess_Freq[31:0],Internal_Debug_Freq[31:0],ADC_Override,FIFO_out[13:0],FIFO_clock,Control_Kp[31:0],Control_Ki[31:0],Freq_Measured[31:0],s_axis_tdata_ADC_Stream_in[31:0],s_axis_tvalid_ADC_Stream_in,s_axis_tready_ADC_Stream_in,DAC_Stream_out[31:0],AD_CLK_in,Sys_CLK_in,Reset_In" */;
