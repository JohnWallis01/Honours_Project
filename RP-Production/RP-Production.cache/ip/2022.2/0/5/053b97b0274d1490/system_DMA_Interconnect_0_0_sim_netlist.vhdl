...
\m_axis_tdata_reg[25]\: unisim.vcomponents.FDSE
     port map (
      C => aclk,
      CE => p_0_in,
      D => s_axis_tdata(25),
...
\m_axis_tdata_reg[27]\: unisim.vcomponents.FDSE
     port map (
      C => aclk,
      CE => p_0_in,
      D => s_axis_tdata(27),
...
\m_axis_tdata_reg[29]\: unisim.vcomponents.FDSE
     port map (
      C => aclk,
      CE => p_0_in,
      D => s_axis_tdata(29),
...
\m_axis_tdata_reg[31]\: unisim.vcomponents.FDSE
     port map (
      C => aclk,
      CE => p_0_in,
      D => s_axis_tdata(31),
...
m_axis_tvalid_reg: unisim.vcomponents.FDSE
     port map (
      C => aclk,
      CE => p_0_in,
      D => s_axis_tvalid,
