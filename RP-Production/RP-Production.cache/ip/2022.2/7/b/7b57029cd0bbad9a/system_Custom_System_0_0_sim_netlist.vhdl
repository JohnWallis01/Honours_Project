...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NCO is
  signal OffsetPhase : STD_LOGIC_VECTOR ( 31 downto 22 );
...
begin
  ...
  Target_Signal_out(13) <= \^target_signal_out\(13);
  Target_Signal_out(12) <= \^target_signal_out\(0);
  Target_Signal_out(11) <= \^target_signal_out\(13);
  Target_Signal_out(10) <= \^target_signal_out\(0);
  Target_Signal_out(9) <= \^target_signal_out\(13);
  Target_Signal_out(8) <= \^target_signal_out\(0);
  Target_Signal_out(7) <= \^target_signal_out\(13);
  Target_Signal_out(6) <= \^target_signal_out\(0);
  Target_Signal_out(5) <= \^target_signal_out\(13);
  Target_Signal_out(4) <= \^target_signal_out\(0);
  Target_Signal_out(3) <= \^target_signal_out\(13);
  Target_Signal_out(2) <= \^target_signal_out\(0);
  Target_Signal_out(1) <= \^target_signal_out\(13);
  Target_Signal_out(0) <= \^target_signal_out\(0);
  s_axis_tready_ADC_Stream_in <= \<const1>\;
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
\Target_Signal_out[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^target_signal_out\(0),
      I1 => Reset_In,
