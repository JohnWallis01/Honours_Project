...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PIG_Controller is
  port (
    ...
    kG : in STD_LOGIC_VECTOR ( 31 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PIG_Controller is
  ...
  signal \Integral_Stage[31]_i_2_n_0\ : STD_LOGIC;
  signal \Integral_Stage[31]_i_3_n_0\ : STD_LOGIC;
  signal \Integral_Stage[31]_i_4_n_0\ : STD_LOGIC;
  signal \Integral_Stage[31]_i_5_n_0\ : STD_LOGIC;
  ...
  signal Sig_Buffer1 : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal \^sig_buffer_reg\ : STD_LOGIC_VECTOR ( 31 downto 16 );
  ...
  signal \SignalOutput[31]_i_2_n_0\ : STD_LOGIC;
  signal \SignalOutput[31]_i_3_n_0\ : STD_LOGIC;
  signal \SignalOutput[31]_i_4_n_0\ : STD_LOGIC;
  signal \SignalOutput[31]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \SignalOutput_reg[31]_i_1_n_1\ : STD_LOGIC;
  signal \SignalOutput_reg[31]_i_1_n_2\ : STD_LOGIC;
  signal \SignalOutput_reg[31]_i_1_n_3\ : STD_LOGIC;
  ...
  signal \NLW_Sig_Buffer1_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \NLW_Sig_Buffer2_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_Sig_Buffer2_inferred__0/i__carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \NLW_SignalOutput_reg[31]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute METHODOLOGY_DRC_VIOS of Sig_Buffer0 : label is "{SYNTH-10 {cell *THIS*} {string 15x18 4}}";
  ...
  attribute METHODOLOGY_DRC_VIOS of \Sig_Buffer2__1\ : label is "{SYNTH-10 {cell *THIS*} {string 18x15 4}}";
  attribute METHODOLOGY_DRC_VIOS of \Sig_Buffer2__2\ : label is "{SYNTH-10 {cell *THIS*} {string 15x18 4}}";
  attribute METHODOLOGY_DRC_VIOS of \Sig_Buffer2__3\ : label is "{SYNTH-10 {cell *THIS*} {string 18x18 4}}";
  attribute METHODOLOGY_DRC_VIOS of \Sig_Buffer2__4\ : label is "{SYNTH-10 {cell *THIS*} {string 18x15 4}}";
  ...
  attribute METHODOLOGY_DRC_VIOS of Sig_Buffer_reg : label is "{SYNTH-10 {cell *THIS*} {string 18x15 4}}";
  ...
  attribute ADDER_THRESHOLD of \SignalOutput_reg[31]_i_1\ : label is 35;
begin
...
\Integral_Stage[31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Integral_Stage[31]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Integral_Stage[31]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Integral_Stage[31]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Integral_Stage_reg[31]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \Integral_Stage[31]_i_2_n_0\,
      S(2) => \Integral_Stage[31]_i_3_n_0\,
      S(1) => \Integral_Stage[31]_i_4_n_0\,
      S(0) => \Integral_Stage[31]_i_5_n_0\
    );
...
\Sig_Buffer1_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_Sig_Buffer1_carry__6_CO_UNCONNECTED\(3),
      CO(2) => \Sig_Buffer1_carry__6_n_1\,
      CO(1) => \Sig_Buffer1_carry__6_n_2\,
      CO(0) => \Sig_Buffer1_carry__6_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \Sig_Buffer2_inferred__0/i__carry__2_n_5\,
      DI(1) => \Sig_Buffer2_inferred__0/i__carry__2_n_6\,
      DI(0) => \Sig_Buffer2_inferred__0/i__carry__2_n_7\,
      O(3 downto 0) => Sig_Buffer1(31 downto 28),
...
\Sig_Buffer2_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_Sig_Buffer2_carry__2_CO_UNCONNECTED\(3),
      CO(2) => \Sig_Buffer2_carry__2_n_1\,
      CO(1) => \Sig_Buffer2_carry__2_n_2\,
      CO(0) => \Sig_Buffer2_carry__2_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \Sig_Buffer2__1_n_92\,
      DI(1) => \Sig_Buffer2__1_n_93\,
...
\Sig_Buffer2_inferred__0/i__carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_Sig_Buffer2_inferred__0/i__carry__2_CO_UNCONNECTED\(3),
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \Sig_Buffer2__4_n_92\,
      DI(1) => \Sig_Buffer2__4_n_93\,
...
Sig_Buffer_reg: unisim.vcomponents.DSP48E1
    generic map(
      ...
      B(16) => Sig_Buffer1(31),
      B(15) => Sig_Buffer1(31),
      B(14 downto 0) => Sig_Buffer1(31 downto 17),
      BCIN(17 downto 0) => B"000000000000000000",
...
\SignalOutput[31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\SignalOutput[31]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\SignalOutput[31]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\SignalOutput[31]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\SignalOutput_reg[31]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \SignalOutput_reg[27]_i_1_n_0\,
      CO(3) => \NLW_SignalOutput_reg[31]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \SignalOutput_reg[31]_i_1_n_1\,
      CO(1) => \SignalOutput_reg[31]_i_1_n_2\,
      CO(0) => \SignalOutput_reg[31]_i_1_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => Sig_Buffer_reg_n_92,
      DI(1) => Sig_Buffer_reg_n_93,
      DI(0) => Sig_Buffer_reg_n_94,
      O(3 downto 0) => \^sig_buffer_reg\(31 downto 28),
      S(3) => \SignalOutput[31]_i_2_n_0\,
      S(2) => \SignalOutput[31]_i_3_n_0\,
      S(1) => \SignalOutput[31]_i_4_n_0\,
      S(0) => \SignalOutput[31]_i_5_n_0\
    );
