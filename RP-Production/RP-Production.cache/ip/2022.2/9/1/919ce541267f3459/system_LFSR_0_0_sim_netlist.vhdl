...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LFSR2008 is
  ...
  signal p_28_out : STD_LOGIC_VECTOR ( 9 downto 1 );
...
begin
  PRBS <= \^prbs\;
  State(9 downto 0) <= \^state\(9 downto 0);
...
LFSR: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LFSR2008
     port map (
      PRBS => PRBS,
      State(9 downto 0) => Q(9 downto 0),
      Taps(8 downto 0) => Taps(8 downto 0),
      clock => clock,
      reset => reset
    );
end STRUCTURE;
