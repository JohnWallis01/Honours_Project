...
ISEStep( "vivado",
         "-log Differental_Phasemeter_DAC_Router_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Differental_Phasemeter_DAC_Router_0_0.tcl" );
