...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(PLL_Guess_Freq, Internal_Debug_Freq, 
  ...
  DAC_Stream_out, AD_CLK_in, Sys_CLK_in, Reset_In, Reset_Out, Integrator_Reset, Debug_Signal, 
  Timer_Value, Timer_Enable, Target_Signal_out)
/* synthesis syn_black_box black_box_pad_pin="PLL_Guess_Freq[31:0],Internal_Debug_Freq[31:0],ADC_Override,Control_Kp[31:0],Control_Ki[31:0],Control_Lock_Threshold[25:0],Lock_Detect,Freq_Measured[31:0],s_axis_tdata_ADC_Stream_in[31:0],s_axis_tvalid_ADC_Stream_in,s_axis_tready_ADC_Stream_in,DAC_Stream_out[31:0],AD_CLK_in,Sys_CLK_in,Reset_In,Reset_Out,Integrator_Reset,Debug_Signal[13:0],Timer_Value[31:0],Timer_Enable,Target_Signal_out[13:0]" */;
