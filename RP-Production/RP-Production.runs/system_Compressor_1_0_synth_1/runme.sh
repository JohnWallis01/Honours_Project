...
HD_PWD='C:/Users/John/Desktop/Honours_Project/RP-Production/RP-Production.runs/system_Compressor_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Compressor_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Compressor_1_0.tcl
