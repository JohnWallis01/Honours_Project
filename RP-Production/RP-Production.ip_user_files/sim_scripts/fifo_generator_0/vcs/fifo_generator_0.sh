...
#
# Generated by Vivado on Sat Apr 22 16:38:16 +0800 2023
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_7 $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../RP-Production.gen/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
