...
--               e:/Libraries/Documents/UNIFPGA/redpitaya_guide/tmp/1_led_blink/1_led_blink.gen/sources_1/bd/system/ip/system_axis_red_pitaya_dac_1_0/system_axis_red_pitaya_dac_1_0_sim_netlist.vhdl
...
entity system_axis_red_pitaya_dac_1_0_axis_red_pitaya_dac is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_axis_red_pitaya_dac_1_0 is
  port (
    aclk : in STD_LOGIC;
    ddr_clk : in STD_LOGIC;
    locked : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of system_axis_red_pitaya_dac_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_axis_red_pitaya_dac_1_0 : entity is "system_axis_red_pitaya_dac_1_0,axis_red_pitaya_dac,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_axis_red_pitaya_dac_1_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_axis_red_pitaya_dac_1_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_axis_red_pitaya_dac_1_0 : entity is "axis_red_pitaya_dac,Vivado 2022.2";
end system_axis_red_pitaya_dac_1_0;

architecture STRUCTURE of system_axis_red_pitaya_dac_1_0 is
  ...
  attribute X_INTERFACE_PARAMETER of ddr_clk : signal is "XIL_INTERFACENAME ddr_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /SignalGenerator/clk_wiz_0_clk_out1, INSERT_VIP 0";
...
inst: entity work.system_axis_red_pitaya_dac_1_0_axis_red_pitaya_dac
     port map (
      aclk => aclk,
      dac_clk => dac_clk,
