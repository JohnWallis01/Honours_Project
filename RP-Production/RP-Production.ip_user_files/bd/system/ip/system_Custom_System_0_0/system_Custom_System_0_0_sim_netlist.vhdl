...
entity system_Custom_System_0_0_Custom_System is
  port (
    ...
    Target_Signal_out : out STD_LOGIC_VECTOR ( 0 to 0 );
    DAC_Stream_out : out STD_LOGIC_VECTOR ( 12 downto 0 );
...
architecture STRUCTURE of system_Custom_System_0_0_Custom_System is
  ...
  attribute XILINX_LEGACY_PRIM of Write_State_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of Write_State_reg : label is "VCC:GE GND:CLR";
begin
  Reset_Out <= \^reset_out\;
...
Write_State_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of system_Custom_System_0_0 is
  ...
  signal \^target_signal_out\ : STD_LOGIC_VECTOR ( 11 to 11 );
...
begin
  ...
  Target_Signal_out(13) <= \^target_signal_out\(11);
  Target_Signal_out(12) <= \<const0>\;
  Target_Signal_out(11) <= \^target_signal_out\(11);
  Target_Signal_out(10) <= \<const0>\;
  Target_Signal_out(9) <= \^target_signal_out\(11);
  Target_Signal_out(8) <= \<const0>\;
  Target_Signal_out(7) <= \^target_signal_out\(11);
  Target_Signal_out(6) <= \<const0>\;
  Target_Signal_out(5) <= \^target_signal_out\(11);
  Target_Signal_out(4) <= \<const0>\;
  Target_Signal_out(3) <= \^target_signal_out\(11);
  Target_Signal_out(2) <= \<const0>\;
  Target_Signal_out(1) <= \^target_signal_out\(11);
  Target_Signal_out(0) <= \<const0>\;
...
inst: entity work.system_Custom_System_0_0_Custom_System
     port map (
      ...
      Reset_In => Reset_In,
      Reset_Out => Reset_Out,
      Target_Signal_out(0) => \^target_signal_out\(11),
      s_axis_tdata_ADC_Stream_in(13 downto 0) => s_axis_tdata_ADC_Stream_in(13 downto 0),
