...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_Phase_Locked_Loop_0_0_CIC32 is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_Phase_Locked_Loop_0_0_Mixer is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_Phase_Locked_Loop_0_0_NCO is
  port (
...
architecture STRUCTURE of system_Phase_Locked_Loop_0_0_NCO is
  ...
  signal \Quadrature_buffer_reg__0\ : STD_LOGIC_VECTOR ( 12 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Dout[10]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Dout[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Dout[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Dout[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Dout[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Dout[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Dout[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Dout[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Dout[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Dout[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Dout[8]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Dout[9]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \Quadrature_addr[7]_i_2\ : label is "soft_lutpair2";
...
Dout_reg_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
Dout_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
        ...
        port map (
      I0 => \sigbuffer_reg_n_0_[0]\,
      I1 => \Quadrature_buffer_reg__0\(12),
      I2 => p_0_in_0,
      O => B(12)
    );
Dout_reg_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
        ...
        port map (
      I0 => \sigbuffer_reg_n_0_[0]\,
      I1 => \Quadrature_buffer_reg__0\(11),
      I2 => p_0_in_0,
      O => B(11)
    );
Dout_reg_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
        ...
        port map (
      I0 => \sigbuffer_reg_n_0_[0]\,
      I1 => \Quadrature_buffer_reg__0\(10),
      I2 => p_0_in_0,
      O => B(10)
    );
...
Quadrature_buffer_reg: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      DOADO(12 downto 0) => \Quadrature_buffer_reg__0\(12 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_Phase_Locked_Loop_0_0_PID_Controller is
  port (
...
architecture STRUCTURE of system_Phase_Locked_Loop_0_0_Phase_Locked_Loop is
  ...
  signal PLL_NCO_n_58 : STD_LOGIC;
  signal PLL_NCO_n_59 : STD_LOGIC;
...
Loop_Controller: entity work.system_Phase_Locked_Loop_0_0_PID_Controller
     port map (
      AD_CLK_in => AD_CLK_in,
...
Loop_Filter: entity work.system_Phase_Locked_Loop_0_0_CIC32
     port map (
      AD_CLK_in => AD_CLK_in,
...
PLL_NCO: entity work.system_Phase_Locked_Loop_0_0_NCO
     port map (
      AD_CLK_in => AD_CLK_in,
      B(13) => PLL_NCO_n_46,
      B(12) => PLL_NCO_n_47,
...
Quadrature_Mixer: entity work.system_Phase_Locked_Loop_0_0_Mixer
     port map (
      AD_CLK_in => AD_CLK_in,
      B(13) => PLL_NCO_n_46,
      B(12) => PLL_NCO_n_47,
...
entity system_Phase_Locked_Loop_0_0 is
  ...
  attribute IP_DEFINITION_SOURCE of system_Phase_Locked_Loop_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_Phase_Locked_Loop_0_0 : entity is "Phase_Locked_Loop,Vivado 2022.2";
