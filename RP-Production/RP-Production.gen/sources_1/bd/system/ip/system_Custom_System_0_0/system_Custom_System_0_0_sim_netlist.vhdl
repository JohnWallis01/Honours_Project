...
architecture STRUCTURE of system_Custom_System_0_0_Custom_System is
  ...
  attribute XILINX_LEGACY_PRIM of Init_State_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of Init_State_reg : label is "VCC:GE GND:CLR";
  attribute ADDER_THRESHOLD : integer;
...
Init_State_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '1'
    )
        port map (
