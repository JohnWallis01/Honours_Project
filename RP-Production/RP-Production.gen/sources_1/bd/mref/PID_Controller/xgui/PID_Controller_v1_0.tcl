...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Inital" -parent ${Page_0}
...
proc update_PARAM_VALUE.Inital { PARAM_VALUE.Inital } {
	# Procedure called to update Inital when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Inital { PARAM_VALUE.Inital } {
	# Procedure called to validate Inital
	return true
}
...
proc update_MODELPARAM_VALUE.Inital { MODELPARAM_VALUE.Inital PARAM_VALUE.Inital } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Inital}] ${MODELPARAM_VALUE.Inital}
}
