...
HD_PWD='C:/Users/John/Desktop/Honours_Project/Zynq_Testing/Zynq_Testing.runs/system_ConstantIP_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ConstantIP_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ConstantIP_2_0.tcl
