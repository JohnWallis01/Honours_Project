...
module system
  ...
  wire [15:0]FIR_Filter_2_0_Signal_Output;
  wire [31:0]Mixer_0_Dout;
  wire [15:0]NCO_0_Dout;
  wire [15:0]NCO_1_Dout;
  wire [15:0]PIG_Controller_0_SignalOutput;
  wire clock_1;

  assign Data[15:0] = PIG_Controller_0_SignalOutput;
  ...
  system_ConstantIP_4_0 ConstantIP_4
       (.D(ConstantIP_4_D));
  system_FIR_Filter_2_0_0 FIR_Filter_2_0
       (.Signal_Input(Compressor_0_D),
        .Signal_Output(FIR_Filter_2_0_Signal_Output),
        .clock(clock_1));
  ...
  system_NCO_1_0 NCO_1
       (.Dout(NCO_1_Dout),
        .Frequency(FIR_Filter_2_0_Signal_Output),
        .PhaseOffset(ConstantIP_3_D),
        .clock(clock_1),
        .rst(ConstantIP_4_D));
  system_PIG_Controller_0_0 PIG_Controller_0
       (.SignalInput(FIR_Filter_2_0_Signal_Output),
