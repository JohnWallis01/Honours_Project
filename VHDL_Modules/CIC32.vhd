...
-- Generated on: 2023-03-21 12:26:43
-- -------------------------------------------------------------
...
--   Integrator Section 1  : s26,15
--   Integrator Section 2  : s26,15
--   Comb Section 1        : s26,15
--   Comb Section 2        : s26,15
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: CIC32
----------------------------------------------------------------
ARCHITECTURE rtl OF CIC32 IS
  -- Local Functions
  -- Type Definitions
  -- Constants
  -- Signals
  ...
  SIGNAL section_cast1                    : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sum1                             : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL section_out1                     : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_cast                         : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_cast_1                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_temp                         : signed(26 DOWNTO 0); -- sfix27_En15
  --   -- Section 2 Signals 
  SIGNAL section_in2                      : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sum2                             : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL section_out2                     : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_cast_2                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_cast_3                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL add_temp_1                       : signed(26 DOWNTO 0); -- sfix27_En15
  --   -- Section 3 Signals 
  SIGNAL section_in3                      : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL diff1                            : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL section_out3                     : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_cast                         : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_cast_1                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_temp                         : signed(26 DOWNTO 0); -- sfix27_En15
  SIGNAL cic_pipeline3                    : signed(25 DOWNTO 0); -- sfix26_En15
  --   -- Section 4 Signals 
  SIGNAL section_in4                      : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL diff2                            : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL section_out4                     : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_cast_2                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_cast_3                       : signed(25 DOWNTO 0); -- sfix26_En15
  SIGNAL sub_temp_1                       : signed(26 DOWNTO 0); -- sfix27_En15
  --   
  SIGNAL output_register                  : signed(25 DOWNTO 0); -- sfix26_En15
...
BEGIN
  ...
  section_out3 <= sub_temp(25 DOWNTO 0);
  ...
  section_out4 <= sub_temp_1(25 DOWNTO 0);
